...
const features = [
  ...
  },
  {
    ...
    description:
      'We increase sales and clicks by ranking your site higher in the search results.',
    icon: DeviceChartIcon,
  },
  {
    name: 'Website Analytics and Security',
    description:
      'Implementing advanced analytics and website security strategies.',
    icon: DeviceLockIcon,
  },
  {
    name: 'Website Hosting',
    description:
      'Providing reliable and secure hosting solutions for your website.',
    icon: DeviceListIcon,
  },
  {
    name: 'Website Maintenance',
    description:
      'Offering ongoing support and updates to keep your website running smoothly.',
  ...
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      ...
      <defs>
        ...
        >
          <stop stopColor="#f36cff" />
          <stop offset={1} stopColor="#f36cff" stopOpacity={0} />
        </linearGradient>
      </defs>
    </svg>
  )
  ...
  return (
    <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" {...props}>
      <path
        ...
        fill="#f36cff"
      />
      <circle cx={11} cy={14} r={2} fill="#f36cff" />
      <circle cx={11} cy={20} r={2} fill="#f36cff" />
      <circle cx={11} cy={26} r={2} fill="#f36cff" />
      <path
      ...
      <Container>
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-2 text-lg text-gray-600">
            We are a team of designers and software engineers that have worked with the biggest 
