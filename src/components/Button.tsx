...
const baseStyles = {
  solid:
    'font-medium inline-flex justify-center items-center rounded-lg py-2 px-3 text-sm outline-2 outline-offset-2 transition-colors',
  outline:
    'font-medium inline-flex justify-center items-center rounded-lg border py-[calc(theme(spacing.2)-1px)] px-[calc(theme(spacing.3)-1px)] text-sm outline-2 outline-offset-2 transition-colors',
};
